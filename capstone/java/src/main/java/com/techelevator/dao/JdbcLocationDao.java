...
public class JdbcLocationDao implements LocationDao {
    ...
    public List<Location> getLocations() {
        ...
        String sql = "SELECT location_id, address_1, address_2, city, state_abbreviation, zip_code, latitude, longitude \n" +
                "FROM locations;";
    ...
    public Location createLocation(Location newLocation) {
        String sql = "INSERT INTO locations (address_1,address_2,city,state_abbreviation,zip_code,latitude,longitude) \n" +
                "VALUES (?,?,?,?,?,?,?)\n" +
